...
public class View1 extends LinearLayout implements Observer {
	...
	private Model model;
    private View selectButton, eraseButton, rectangleButton, circleButton, lineButton, zoomButton, paintButton;
	...
	public void update(Observable observable, Object data) {
        ...
        if (tool != 'r' && tool != 'c' && tool!= 'l' && tool !='z') { // put stroke buttons to inactive
        ...
        if (tool == 's') {
            ...
            zoomButton.setBackgroundColor(Color.WHITE);
        ...
        if (tool == 'z') {
            ...
            rectangleButton.setBackgroundColor(Color.WHITE);
            circleButton.setBackgroundColor(Color.WHITE);
            zoomButton.setBackgroundColor(Color.parseColor("#e0e0e0"));
            lineButton.setBackgroundColor(Color.WHITE);
            paintButton.setBackgroundColor(Color.WHITE);
        }
        if (tool == 'p') {
